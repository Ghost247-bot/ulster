...
const businessInsuranceFeatures = [
  [
...
const faqs = [
  { q: 'What types of business insurance do you offer?', a: 'We offer general liability, commercial property, business interruption, workers compensation, and more.' },
  { q: 'How do I get a quote?', a: 'You can get a quote online or by contacting a local agent.' },
  { q: 'Are there discounts available?', a: 'Yes, we offer discounts for bundling multiple policies and maintaining a good claims history.' },
    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative w-full h-64 md:h-80 bg-gray-100 flex items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-900">business insurance.</h1>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="text-xs text-[#C14F2B] mb-2 uppercase tracking-widest">
          HOME &gt; BUSINESS &gt; INSURANCE &gt; BUSINESS INSURANCE
        </div>
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          {/* Main Info */}
          <div className="flex-1 min-w-0">
            <h2 className="text-2xl md:text-3xl font-semibold mb-2">Business Insurance</h2>
            <p className="mb-4 text-gray-700">Protect your business with comprehensive insurance solutions. From general liability to cyber insurance, we have coverage options to meet your needs.</p>
            <p className="mb-4 text-gray-700">Enjoy competitive rates, personalized service, and peace of mind knowing your business is protected.</p>
          </div>
          {/* Promo Box */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {businessInsuranceFeatures.map((col, idx) => (
