    ...
    <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-6">Wealth Management</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Our wealth management services help you achieve your financial goals through personalized investment strategies and expert guidance.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 mb-4">Comprehensive financial planning tailored to your unique goals and circumstances.</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 mb-4">Expert investment advice and portfolio management to help grow your wealth.</p>
            <Link to="/contact" className="inline-flex items-center text-[#C14F2B] font-medium hover:text-[#C14F2B]/80 transition-colors duration-200">
              Learn More
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
            ...
            <p className="text-gray-600 mb-4">Strategic estate planning to protect and transfer your wealth according to your wishes.</p>
            <Link to="/contact" className="inline-flex items-center text-[#C14F2B] font-medium hover:text-[#C14F2B]/80 transition-colors duration-200">
              Learn More
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Why Choose Our Wealth Management Services?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex flex-col items-center text-center p-4">
              ...
              <p className="text-gray-600">Tailored strategies based on your unique financial situation and goals.</p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <div className="w-16 h-16 rounded-full bg-[#C14F2B]/10 flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-[#C14F2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Holistic approach covering all aspects of your financial life.</p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <div className="w-16 h-16 rounded-full bg-[#C14F2B]/10 flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-[#C14F2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Strategic tax planning to maximize your wealth preservation.</p>
            </div>
            <div className="flex flex-col items-center text-center p-4">
              <div className="w-16 h-16 rounded-full bg-[#C14F2B]/10 flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-[#C14F2B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600">Continuous portfolio review and strategy adjustments.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#C14F2B] rounded-3xl p-8 text-center">
          <h2 className="text-2xl font-bold text-white mb-4">Ready to Grow Your Wealth?</h2>
          <p className="text-white/90 mb-8 max-w-2xl mx-auto">Start your journey towards financial success with our comprehensive wealth management services.</p>
