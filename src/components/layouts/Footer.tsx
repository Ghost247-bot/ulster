    ...
    <footer className="bg-primary-900 text-white">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          {/* Company Info */}
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6">About Us</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link to="/personal-banking" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Personal Banking
                </Link>
              </li>
              <li>
                <Link to="/business-banking" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Business Banking
                </Link>
              </li>
              <li>
                <Link to="/wealth-management" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Wealth Management
                </Link>
              </li>
              <li>
                <Link to="/loans" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Loans & Mortgages
                </Link>
              </li>
              <li>
                <Link to="/insurance" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Insurance
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link to="/security" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Security
                </Link>
              </li>
              <li>
                <Link to="/accessibility" className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm">
                  Accessibility
                </Link>
              </li>
            </ul>
