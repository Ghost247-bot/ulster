        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link to="/dashboard" className="flex items-center space-x-3 group">
              <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-primary-600 to-primary-700 flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-300 ease-out">
                <Building2 className="h-6 w-6 text-white group-hover:rotate-3 transition-transform duration-300" />
              </div>
              <div className="hidden sm:block">
                <h1 className="text-xl font-bold text-gray-900 group-hover:text-primary-600 transition-colors duration-300">Ulster Bank</h1>
                <p className="text-xs text-gray-500 -mt-1 group-hover:text-gray-600 transition-colors duration-300">Online Banking</p>
              </div>
            </Link>
          </div>
          ...
          <nav className="hidden lg:flex items-center space-x-1">
            <Link
              to="/dashboard"
              className="relative px-4 py-2 text-sm font-medium text-gray-700 hover:text-primary-600 hover:bg-gray-50 rounded-md transition-all duration-300 ease-out hover:scale-105 group"
            >
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link
              to="/notifications"
              className="relative p-2 text-gray-600 hover:text-primary-600 hover:bg-gray-100 rounded-full transition-all duration-300 ease-out hover:scale-110 group"
            >
              <Bell className="h-5 w-5 group-hover:animate-pulse" />
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center animate-pulse group-hover:animate-bounce">
                3
              </span>
            </Link>
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="flex items-center space-x-2 p-2 text-gray-700 hover:text-primary-600 hover:bg-gray-100 rounded-lg transition-all duration-300 ease-out hover:scale-105 group"
              >
                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center shadow-sm group-hover:shadow-md transition-all duration-300">
                  <span className="text-sm font-semibold text-white group-hover:scale-110 transition-transform duration-300">
            ...
            <button
              ...
              className="lg:hidden p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-md transition-all duration-300 ease-out hover:scale-110 group"
            >
              <span className="sr-only">Open main menu</span>
              <div className="relative">
                <X className={`h-6 w-6 absolute transition-all duration-300 ease-out ${isMobileMenuOpen ? 'rotate-0 opacity-100' : 'rotate-90 opacity-0'}`} />
                <Menu className={`h-6 w-6 transition-all duration-300 ease-out ${isMobileMenuOpen ? 'rotate-90 opacity-0' : 'rotate-0 opacity-100'}`} />
              </div>
            </button>
          </div>
        </div>
      ...
      <div className={`lg:hidden transition-all duration-500 ease-out ${
        ...
        <div className="bg-white border-t border-gray-200 shadow-lg backdrop-blur-sm bg-white/95">
          <div className="px-4 py-3 space-y-1">
            <Link
              to="/dashboard"
              className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-primary-600 hover:bg-gray-50 rounded-md transition-all duration-300 ease-out hover:translate-x-2 hover:scale-105 group"
          ...
          <div className="border-t border-gray-200 px-4 py-3">
            <div className="flex items-center space-x-3 mb-3 group">
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
