-- Restore user_financial_goals table after rollback
-- This migration recreates the financial goals table with proper admin policies
...
-- These will be added if the profiles table has the is_admin column
DO $$
BEGIN
...
-- Insert default financial goals for existing users (only if table is empty)
